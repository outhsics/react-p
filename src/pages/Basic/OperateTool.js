...
import {
  message, Card, Icon, Form, Row, Col, Button, Input, DatePicker,
  Popconfirm,
  InputNumber
} from 'antd';
            ...
            {specialList && specialList.map(item => {
              return <Col span={8} key={item.id}>
                <Card
                  ...
                  title={item.title}
                  extra={<Fragment>
                    <a style={{ marginRight: 10 }} onClick={this.handleEdit.bind(this, item)} >编辑</a>
                    <Popconfirm title="确定删除?" onConfirm={this.handleDelete.bind(this, item)} onCancel={cancel} okText="Yes" cancelText="No">
                      <a href="#">删除</a>
                    </Popconfirm>
                  </Fragment>}
                >
                ...
                <Col span={12}>
                  ...
                  >
                    {getFieldDecorator('title', {
                      rules: [{ required: true, message: '请输入专项训练名称（不超过10个字）' },
                ...
                <Col span={12}>
                  ...
                  >
                    {getFieldDecorator('slogan', {
                      rules: [{ required: true, message: '请输入输入该专项训练的slogan（不超过12个字）' },
                ...
                <Col span={12}>
                  ...
                  >
                    {getFieldDecorator('content', {
                      rules: [{ required: true, message: '请输入文字,字数不得超过180' },
                      { validator: validatorContent },
                      ],
                    })(
                      <Input.TextArea placeholder={'专项说明文本（0/180）'}
                  ...
                  <Row>
                    ...
                    >
                      {getFieldDecorator('button', {
                        rules: [{ required: true, message: '输入该专项训练的按钮文本（不超过12个字）!' },
                        { validator: validatorSlogan },
